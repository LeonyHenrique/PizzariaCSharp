...
using PizzariaCSharp.Models.Pedido;
...
var controlherBebida = new BebidaController(new BebidasRepository());
...
var cliente1 = controlherCliente.Adicionar(new Clientes(){Nome= "Jose Francisco",Telefone="02199999999"});
var cliente2 = controlherCliente.Adicionar(new Clientes(){Nome= "Renato Silveira",Telefone="02199999988"});
